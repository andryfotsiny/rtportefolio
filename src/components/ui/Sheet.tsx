...
const SheetClose = SheetPrimitive.Close; // Correction from 'closed' to 'Close'
...
const SheetHeader: React.FC<React.ComponentPropsWithoutRef<'div'>> = ({ className, ...props }) => (
  <div
...
const SheetFooter: React.FC<React.ComponentPropsWithoutRef<'div'>> = ({ className, ...props }) => (
  <div
    className={cn(
